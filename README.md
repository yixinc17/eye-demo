...
| 表情 | L.upper.y | R.upper.y | L.rot | R.rot | L.lower.y | R.lower.y | R.lower.rot | pupil.scale | gaze | duration |
|------|-----------|-----------|-------|-------|-----------|-----------|-------------|-------------|------|----------|
| **wink** | -100 | -70 | 0.3 | -0.3 | 172 | 60 | -0.3 | 0.75 | none | normal |

### 睡眠类

| 表情 | upper.y | lower.y | pupil.scale | gaze | duration | 特殊属性 |
|------|---------|---------|-------------|------|----------|----------|
| **sleepy** | -100 | 130 | 0.7 | none | slow | eyelidAnim(循环), holdDuration:10s, nextPose:sleep |
| **sleep** | -50 | 69 | 0.7 | none | slow | eyelidAnim(微动), holdDuration:null, direct, allowedFrom:[sleepy] |

### 醒来类

| 表情 | upper.y | lower.y | pupil.scale | gaze | duration | 特殊属性 |
|------|---------|---------|-------------|------|----------|----------|
| **wakeup** | -240 | 172 | 0.7 | follow | 1200ms | direct, allowedFrom:[sleepy,sleep,daze], autoReturnToIdle |
